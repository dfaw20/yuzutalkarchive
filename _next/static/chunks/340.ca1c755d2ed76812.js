  ...
  [340],
  {
    ...
    8340: function (n, a, e) {
      ...
      var M = function () {
          ...
          if (
              ...
              o(n),
                ...
                p(k.bD.LOCAL) &&
                  [
                    ...
                    var a = window[k.bD.LOCAL].getItem(xn + n.key);
                    "" !== a && null !== a && n.setter(JSON.parse(a));
                  });
              var a = S({
            ...
            t.useEffect(
              function () {
                ln && (f([]), E({}), I(k._n.CHARACTER), L(!1), un(!1), cn(!1));
              },
              [ln]
            ),
            t.useEffect(
              function () {
                fn &&
                  0 !== Object.keys(vn).length &&
                  v
                    .YM(vn, { backgroundColor: u.r.color.chat })
                    .then(function () {
                      v.YM(vn, { backgroundColor: u.r.color.chat })
                        .then(function (n) {
            ...
            t.useEffect(
              function () {
                Cn.setItem(xn + k.Uf.LOCALE, JSON.stringify(e));
              },
              [e]
            ),
              t.useEffect(
                function () {
                  Cn.setItem(xn + k.Uf.SELECT_CHARACTER, JSON.stringify(M));
                },
                [M]
              ),
              t.useEffect(
                function () {
                  Cn.setItem(xn + k.Uf.MESSAGE_LIST, JSON.stringify(d));
                },
                [d]
              ),
              t.useEffect(
                function () {
                  Cn.setItem(xn + k.Uf.SWIPE, JSON.stringify(K));
                },
                [K]
              ),
              t.useEffect(
                function () {
                  Cn.setItem(xn + k.Uf.MESSAGE_SENDER, JSON.stringify(D));
                },
                [D]
              );
          }
          if (p(k.bD.LOCAL)) {
            ...
            t.useEffect(
              function () {
                Zn.setItem(xn + k.Uf.IMAGING_MAGNIFICATION, JSON.stringify(B));
              },
              [B]
            ),
              t.useEffect(
                function () {
                  Zn.setItem(xn + k.Uf.NEWS_LATEST_DATE, JSON.stringify(bn)),
                    (0, m.Z)(
                      g().mark(function n() {
                        var a, t, o;
      ...
      var F = function (n) {
          ...
          return (0, c.tZ)(
            ...
            (0, c.tZ)("div", { css: P, onClick: a.overlayClickHandler })
          );
        },
        K = t.memo(F),
        L = {
        ...
        Y = t.memo(G);
      var U = t.memo(function (n) {
          return (0,
          c.tZ)("div", { css: V(n) }, (0, c.tZ)("header", null, (0, c.tZ)("span", { className: "title" }, n.children)), (0, c.tZ)("button", { type: "button", onClick: n.closeHandler }, (0, c.tZ)(Y, { width: u.r.fontSize.large, height: u.r.fontSize.large, fill: u.r.color.accent })));
        }),
        ...
        sn = t.memo(function (n) {
          ...
          var a = n.headerText,
            ...
            r = on();
          return (0,
          c.tZ)(K, { backgroundColor: n.backgroundColor }, (0, c.tZ)(U, o, a), (0, c.tZ)("div", { css: hn }, (0, c.tZ)("span", { className: "text" }, e)), (0, c.tZ)("footer", { css: ln }, (0, c.tZ)("button", { type: "button", onClick: n.closeHandler }, (0, c.tZ)("span", { className: "text" }, r.text_cancel)), (0, c.tZ)("button", { type: "button", onClick: t }, (0, c.tZ)("span", { className: "text" }, r.text_ok))));
        }),
        hn = (0, c.iv)(
      ...
      var Cn = t.memo(function () {
            ...
            (0, c.tZ)(
              ...
              (0, c.tZ)(
                ...
                n.newsMessages.map(function (n, a) {
                  return (0,
                  c.tZ)("li", { key: a }, (0, c.tZ)("details", null, (0, c.tZ)("summary", null, (0, c.tZ)("time", { dateTime: n.date }, (0, c.tZ)("span", { className: "text" }, Dn().parseZone(n.date).format("LLLL"))), (0, c.tZ)("span", { className: "text" }, n.title)), (0, c.tZ)("div", { css: Pn }, (0, c.tZ)("span", { className: "text" }, n.body))));
                })
              )
            )
          );
          ...
          return (0, c.tZ)(
            ...
            (0, c.tZ)(
              ...
              n.sortKeys.map(function (a, e) {
                return (0,
                c.tZ)("div", { css: Yn, key: e }, (0, c.tZ)("input", { type: "checkbox", name: "sortkey", id: a.key, value: a.key, checked: n.current_key === a.key, onChange: n.sortKeyChangeHandler }), (0, c.tZ)("label", { htmlFor: a.key }, (0, c.tZ)("span", { className: "text" }, a.text)));
              })
            ),
            (0, c.tZ)(
              "footer",
        ...
        $n = t.memo(function () {
          var n = qn();
          return (0,
          c.tZ)(K, { backgroundColor: u.r.color.secondary }, (0, c.tZ)(U, { color: u.r.color.accent, backgroundColor: u.r.color.secondary, fontSize: "".concat(u.r.fontSize.large), justify: "center", underBarColor: u.r.color.primary, borderColor: u.r.color.border, closeHandler: n.closeHandler }, n.headerText));
        }),
        na = function () {
          var n = i.Zl(s.D7),
            a = t.useState(""),
    ...
    4855: function (n, a, e) {
      ...
      var t = e(2804),
        ...
        v = (0, t.cn)({ key: "ClearAllMessagesState", default: !1 }),
        S =
          ((0, t.cn)({ key: "TweetState", default: !1 }),
          (0, t.cn)({ key: "RenderRefState", default: {} })),
        x = (0, t.cn)({ key: "NewsBadgeState", default: !1 }),
        w = (0, t.cn)({ key: "NewsLatestDateState", default: "" }),
