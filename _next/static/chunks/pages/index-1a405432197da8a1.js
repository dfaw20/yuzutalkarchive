  ...
  [405],
  {
    4442: function (e, t, n) {
      ...
      var p = o.lazy(function () {
        ...
        h = o.memo(function () {
          var e = d();
          return (0,
          u.tZ)("main", { css: S }, (0, u.tZ)("div", (0, i.Z)({ css: y(e.swipe) }, e.swipeHandler), (0, u.tZ)(p, null), (0, u.tZ)(g, null)));
        }),
        S = { name: "140s9x", styles: "grid-area:main;overflow:hidden" },
        v = (0, u.F4)(
          r ||
            (r = (0, a.Z)([
              "\n    100% {\n        visibility: hidden;\n    }\n",
    ...
    4855: function (e, t, n) {
      ...
      var r = n(2804),
        ...
        g = (0, r.cn)({ key: "ImagingMagnificationState", default: 1 }),
        h = (0, r.cn)({ key: "DeleteModeState", default: !1 }),
        S = (0, r.cn)({ key: "DeleteMessageState", default: -1 }),
              ...
              (t && "touches" in t && t.touches.length > 1) ||
                e(function (e, n) {
                  ...
                  var i = "touches" in t ? t.touches[0] : t,
                    u = S([i.clientX, i.clientY], n.rotationAngle);
                  return a({}, e, l, {
                    initial: [].concat(u),
                    xy: u,
                    start: t.timeStamp || 0,
            ...
            r = function (t) {
              e(function (e, n) {
                ...
                var r = "touches" in t ? t.touches[0] : t,
                  i = S([r.clientX, r.clientY], n.rotationAngle),
                  u = i[0],
                  o = i[1],
                  c = u - e.xy[0],
                  l = o - e.xy[1],
